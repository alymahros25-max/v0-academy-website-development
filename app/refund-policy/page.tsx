...
export default async function RefundPolicyPage() {
  ...
  const page = await getLegalPage('refund-policy', 'ar')

  if (!page) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold">الصفحة غير متاحة</h1>
          <p className="text-muted-foreground mt-2">يرجى المحاولة لاحقاً</p>
        </div>
      </div>
    )
  }
