...
export default function UaeArabiaPage() {
  ...
  return <main dir="rtl" className="min-h-screen overflow-hidden bg-background">
    ...
    <section className="saudi-hero relative islamic-pattern text-center"><div className="uae-flag-badge" aria-label="الإمارات العربية المتحدة" title="خدمة أونلاين مخصصة للطلاب في دولة الإمارات"><span aria-hidden="true">🇦🇪</span></div><div className="mx-auto max-w-4xl px-5 py-20 sm:px-8 lg:py-28"><p className="saudi-eyebrow justify-center"><Sparkles size={16} /> أكاديمية الحافظ المتميز</p><h1 className="mt-6 text-balance text-4xl font-bold leading-tight text-foreground sm:text-6xl">تحفيظ القرآن وتأسيس اللغة العربية أونلاين في الإمارات</h1><p className="mx-auto mt-6 max-w-2xl text-pretty text-lg leading-8 text-muted-foreground sm:text-xl">حصص مرنة لجميع الأعمار من أي مدينة داخل دولة الإمارات</p><div className="mx-auto mt-5 flex max-w-2xl flex-wrap justify-center gap-2 text-sm font-bold"><span className="rounded-full bg-secondary px-4 py-2 text-secondary-foreground">أول حصة تجريبية مجانية</span><span className="rounded-full bg-secondary px-4 py-2 text-secondary-foreground">خصم خاص للأخوة عند التسجيل معاً</span></div><p className="mx-auto mt-5 max-w-3xl text-pretty leading-8 text-muted-foreground">الدراسة أونلاين بالكامل للرجال والنساء والأطفال والشباب والفتيات من دبي وأبوظبي والشارقة وعجمان والعين ورأس الخيمة والفجيرة وأم القيوين وجميع مدن ومناطق الإمارات، من دون الحاجة إلى الحضور لمقر.</p><div className="mt-8 flex flex-wrap justify-center gap-3"><a className="saudi-primary-cta" href={trialUrl} target="_blank" rel="noreferrer"><MessageCircle size={19} /> جرب حصة مجانا</a><a className="saudi-secondary-cta" href="#plans">استعرض الباقات <ChevronLeft size={18} /></a></div></div></section>
