...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "تحفيظ القرآن أونلاين للسعودية والإمارات وقطر",
    "تعليم القرآن للجاليات العربية في أمريكا وأوروبا",
    "معلم قرآن عربي أونلاين",
    "دروس تجويد وحفظ قرآن عن بعد",
    "تأسيس اللغة العربية للأطفال العرب في المهجر",
    "دروس عربية أونلاين للطلاب العرب خارج الوطن العربي",
    "online Quran memorization classes for Arabs abroad",
