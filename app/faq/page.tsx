...
const faqData: FAQItem[] = [
  ...
  // المتابعة (Follow-up)
  { category: "followup", q: { ar: "كيف يمكنني متابعة تقدم طفلي؟", en: "How can I track my child's progress?", fr: "Comment suivre les progres de mon enfant?" }, a: { ar: "نرسل تقارير شهرية مفصلة لأولياء الأمور عبر واتساب أو البريد الإلكتروني تتضمن مستوى الحفظ والتجويد والحضور والسلوك.", en: "We send detailed monthly reports to parents via WhatsApp or email covering memorization level, Tajweed, attendance, and behavior.", fr: "Rapports mensuels detailles via WhatsApp ou email." } },
