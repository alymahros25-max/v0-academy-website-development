          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-primary-foreground/70 text-sm leading-relaxed mb-4">
              {locale === "ar"
                ...
                : locale === "en"
                  ? "A global online academy for Quran memorization and Arabic language foundation with certified teachers."
                  : "Acad\u00e9mie mondiale en ligne pour la m\u00e9morisation du Coran avec des enseignants certifi\u00e9s."}
            </p>
