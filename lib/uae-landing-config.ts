...
export const uaeLandingConfig = {
  ...
  seo: {
    ...
    description: "حصص فردية لتحفيظ القرآن وتأسيس اللغة العربية للأطفال والكبار في دبي وأبوظبي والشارقة وجميع مدن الإمارات، بأسعار بالدرهم الإماراتي وحصة تجريبية مجانية.",
    canonical: "https://quran-elhafez.com/uae",
  },
  cities: ["دبي", "أبوظبي", "الشارقة", "عجمان", "العين", "رأس الخيمة", "الفجيرة", "أم القيوين"],
  whatsappTemplate: "السلام عليكم\n\nأرغب في التسجيل في برنامج الإمارات والأسعار بالدرهم الإماراتي.\n\nالباقة المطلوبة: {plan}\nالاسم:\nالعمر:\nولد أم بنت:\nقرآن أم عربي:\nكمية الحفظ أو مستوى اللغة:\nمعلم أم معلمة:\nالوقت المناسب للحصة التجريبية:",
  plans: [
